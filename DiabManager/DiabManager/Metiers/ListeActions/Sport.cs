...
namespace DiabManager.Metiers.ListeActions
{
    ...
    {
        /// <summary>
        /// La valeur de poids qui modifie le poids du joueur après avoir fait du sport.
        /// </summary>
        ...
        public Sport(string nom, string description, TimeSpan duree, double[] etatInitial, Dictionary<string,double[]> etatFinal, double poids,bool[]jours, params TimeSpan[] values) : base(nom, description, duree, etatInitial, etatFinal, jours, values)
        {
            m_poids = poids;
        }
        ...
        public static new Sport readAction(string[] fields)
        {
            ...
            return new Sport(nom, desc, duree, etatInital, etatFinal, poids, jours, plageHoraire);
        }
    }
}
